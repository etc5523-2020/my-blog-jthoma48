...
Daily confirmed cases incorporates both daily local transmission cases and daily imported cases. Thus, the graph also depicts this. At the start, we briefly see imported cases, shown as the small blue bars, as the only type of reported cases in Singapore. However after, Singapore shut it's doors to tourists and short-term visitors on March 24, 2020 (Ho, 2020), the number of daily imported cases started to decrease. This is evident from the graph as the blue bars start to drop.
